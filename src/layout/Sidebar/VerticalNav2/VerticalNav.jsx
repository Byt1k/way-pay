                                                            ...
                                                            menu.children
                                                                ...
                                                                <React.Fragment>
                                                                    ...
                                                                    <CustomToggle eventKey={index} icon={menu.icon}
                                                                                  links={menu.link} parentPath={menu.path}>
                                                                    <span
                                                                        className={classNames("nav-icon-wrap", {"position-relative": menu.iconBadge})}>
                                                                        ...
                                                                        <span
                                                                            className={classNames("nav-link-text", {"position-relative": menu.badgeIndicator})}>
                                                                        {menu.title}
                                                                            {menu.badgeIndicator && menu.badgeIndicator}
                                                                    </span>
                                                                        {menu.badge && menu.badge}
                                                                    </CustomToggle>
                                                                    <Accordion.Collapse eventKey={index} as="li"
                                                                                        bsPrefix="nav-item"
