                                    ...
                                    <SimpleBar className="dropdown-body  p-2">
                                        <Dropdown.Item>
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="notifications-text">Morgan Freeman accepted your
                                        ...
                                        <Dropdown.Item>
                                            <div className="media">
                                                <div className="media-head">
                                                    <div
                                                        className="avatar  avatar-icon avatar-sm avatar-success avatar-rounded">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="notifications-text">New message received from
                                                            Alan Rickman
                                                        </div>
                                                        <div className="notifications-info">
                                        ...
                                        <Dropdown.Item>
                                            <div className="media">
                                                <div className="media-head">
                                                    <div
                                                        className="avatar  avatar-icon avatar-sm avatar-pink avatar-rounded">
                                                        <span className="initial-wrap">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="notifications-text">You have a follow up with
                                                            Jampack Head on Friday, Dec 19 at 9:30 am
                                                        </div>
                                                        <div className="notifications-info">
                                        ...
                                        <Dropdown.Item>
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="notifications-text">Application of Sarah
                                                            Williams is waiting for your approval
                                                        </div>
                                                        <div className="notifications-info">
                                                            <div className="notifications-time">Today 10:14 PM</div>
                                                        </div>
                                        ...
                                        <Dropdown.Item>
                                            <div className="media">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="notifications-text">Winston Churchil shared a
                                                            document with you
                                                        </div>
                                                        <div className="notifications-info">
                                        ...
                                        <Dropdown.Item>
                                            <div className="media">
                                                <div className="media-head">
                                                    <div
                                                        className="avatar  avatar-icon avatar-sm avatar-danger avatar-rounded">
                                                        <span className="initial-wrap">
                                                ...
                                                <div className="media-body">
                                                    <div>
                                                        <div className="notifications-text">Last 2 days left for the
                                            ...
                                            <div className="media-body">
                                                <Dropdown>
                                                    <Dropdown.Toggle as="a" href="#"
                                                                     className="d-block fw-medium text-dark">Hencework</Dropdown.Toggle>
                                                    <Dropdown.Menu align="end">
                                                        <div className="p-2">
                                                            <div className="media align-items-center active-user mb-3">
                                                                <div className="media-head me-2">
                                                                    <div
                                                                        className="avatar avatar-primary avatar-xs avatar-rounded">
                                                                        <span className="initial-wrap">Hk</span>
                                                                    </div>
                                                                </div>
                                                                <div className="media-body">
                                                                    <Link href="#"
                                                                          className="d-flex link-dark">Hencework <i
                                                                        className="ri-checkbox-circle-fill fs-7 text-primary ms-1"/>
                                                                    </Link>
                                                                    <Link href="#"
                                                            ...
                                                            <div className="media align-items-center mb-3">
                                                                <div className="media-head me-2">
                                                                    <div className="avatar avatar-xs avatar-rounded">
                                                                        <Image src={avatar12} alt="user"
                                                                               className="avatar-img"/>
                                                                    </div>
                                                                </div>
                                                                <div className="media-body">
                                                                    <Link href="#" className="d-block link-dark">Jampack
                                                                        Team</Link>
                                                                    <Link href="#"
                                                                          className="d-block fs-8 link-secondary">contact@hencework.com</Link>
                                                                </div>
                                                            </div>
