var Gantt = (function () {
    ...
    var r = {
        ...
        format(t, e = 'YYYY-MM-DD HH:mm:ss.SSS', s = 'en') {
            const i = new Intl.DateTimeFormat(s, { month: 'long' }).format(t),
            ...
            return (
                Object.keys(o)
                    ...
                    .forEach((t) => {
                        r.includes(t) &&
                            ((r = r.replace(t, `$${d.length}`)), d.push(o[t]));
                    }),
                d.forEach((t, e) => {
                    r = r.replace(`$${e}`, t);
                }),
    ...
    class l {
        ...
        prepare_values() {
            (this.invalid = this.task.invalid),
                ...
                (this.duration =
                    r.diff(this.task._end, this.task._start, 'hour') /
        ...
        draw_bar() {
            (this.$bar = p('rect', {
                ...
                _(this.$bar, 'width', 0, this.width),
                this.invalid && this.$bar.classList.add('bar-invalid');
        }
        draw_progress_bar() {
            this.invalid ||
                ((this.$bar_progress = p('rect', {
                    x: this.x,
                    y: this.y,
        ...
        draw_resize_handles() {
            ...
            p('rect', {
                ...
                this.task.progress &&
                    ...
                    (this.$handle_progress = p('polygon', {
    ...
    class w {
        ...
        setup_wrapper(t) {
            ...
            e
                ...
                : (this.$svg = p('svg', { append_to: s, class: 'gantt' })),
        ...
        setup_tasks(t) {
            (this.tasks = t.map((t, e) => {
                if (
                    ((t._start = r.parse(t.start)),
                    (t._end = r.parse(t.end)),
                    r.diff(t._end, t._start, 'year') > 10 && (t.end = null),
                    (t._index = e),
                    !t.start && !t.end)
                ) {
                    const e = r.today();
                ...
                !t.start && t.end && (t._start = r.add(t._end, -2, 'day')),
                    t.start && !t.end && (t._end = r.add(t._start, 2, 'day'));
                if (
                    (r
                        .get_date_values(t._end)
                        .slice(3)
                        .every((t) => 0 === t) &&
                        (t._end = r.add(t._end, 24, 'hour')),
                    ...
                    : t === m.HALF_DAY
                      ...
                      : t === m.QUARTER_DAY
                        ...
                        : t === m.WEEK
                          ...
                          : t === m.MONTH
                            ? ((this.options.step = 720),
                              (this.options.column_width = 120))
                            : t === m.YEAR &&
                              ((this.options.step = 8760),
                              (this.options.column_width = 120));
        }
        setup_dates() {
        ...
        setup_gantt_dates() {
            ...
            (this.gantt_start = r.start_of(this.gantt_start, 'day')),
                (this.gantt_end = r.start_of(this.gantt_end, 'day')),
                this.view_is([m.QUARTER_DAY, m.HALF_DAY])
                    ? ((this.gantt_start = r.add(this.gantt_start, -7, 'day')),
                      (this.gantt_end = r.add(this.gantt_end, 7, 'day')))
                    : this.view_is(m.MONTH)
                      ? ((this.gantt_start = r.start_of(
                            this.gantt_start,
                            'year',
                        )),
                        (this.gantt_end = r.add(this.gantt_end, 1, 'year')))
                      : this.view_is(m.YEAR)
                        ? ((this.gantt_start = r.add(
                              this.gantt_start,
                              -2,
                              'year',
                          )),
                          (this.gantt_end = r.add(this.gantt_end, 2, 'year')))
                        : ((this.gantt_start = r.add(
                              this.gantt_start,
                              -1,
                              'month',
                          )),
                          (this.gantt_end = r.add(this.gantt_end, 1, 'month')));
        }
        setup_date_values() {
            this.dates = [];
            let t = null;
            for (; null === t || t < this.gantt_end; )
                (t = t
                    ? this.view_is(m.YEAR)
                        ...
                        : this.view_is(m.MONTH)
                          ? r.add(t, 1, 'month')
                          : r.add(t, this.options.step, 'hour')
                    : r.clone(this.gantt_start)),
                    this.dates.push(t);
        }
        bind_events() {
        ...
        setup_layers() {
            ...
            for (let e of t)
                this.layers[e] = p('g', { class: e, append_to: this.$svg });
        }
        make_grid() {
        ...
        make_grid_rows() {
            const t = p('g', { append_to: this.layers.grid }),
                e = p('g', { append_to: this.layers.grid }),
        ...
        make_grid_ticks() {
            ...
            for (let i of this.dates) {
                let n = 'tick';
                this.view_is(m.DAY) && 1 === i.getDate() && (n += ' thick'),
                    this.view_is(m.WEEK) &&
                        i.getDate() >= 1 &&
                        i.getDate() < 8 &&
                        (n += ' thick'),
        ...
        make_grid_highlights() {
            if (this.view_is(m.DAY)) {
                p('rect', {
                    x:
                        (r.diff(r.today(), this.gantt_start, 'hour') /
                            this.options.step) *
                        this.options.column_width,
                    y: 0,
        ...
        make_dates() {
            for (let t of this.get_dates_to_draw())
                if (
                    ...
                    e.getBBox().x2 > this.layers.grid.getBBox().width &&
                        e.remove();
                }
        }
        get_dates_to_draw() {
            ...
            const i = {
                    ...
                    Week_lower:
                        t.getMonth() !== e.getMonth()
                            ? r.format(t, 'D MMM', this.options.language)
                            : r.format(t, 'D', this.options.language),
                    ...
                    Day_upper:
                        t.getMonth() !== e.getMonth()
                            ? r.format(t, 'MMMM', this.options.language)
                            : '',
                    Week_upper:
                        t.getMonth() !== e.getMonth()
                            ? r.format(t, 'MMMM', this.options.language)
                    ...
                    Month_upper:
                        t.getFullYear() !== e.getFullYear()
                            ? r.format(t, 'YYYY', this.options.language)
                            : '',
                    Year_upper:
                        t.getFullYear() !== e.getFullYear()
                            ? r.format(t, 'YYYY', this.options.language)
        ...
        bind_bar_events() {
            ...
            (this.bar_being_dragged = null),
                ...
                document.addEventListener('mouseup', (e) => {
                    (t || i || n) &&
                        o.forEach((t) => t.group.classList.remove('active')),
                        (t = !1),
                        (i = !1),
                        (n = !1);
                }),
                d.on(this.$svg, 'mouseup', (t) => {
                    (this.bar_being_dragged = null),
                        o.forEach((t) => {
                            t.$bar.finaldx &&
                                (t.date_changed(), t.set_action_completed());
                        });
                }),
        ...
        bind_bar_progress() {
            ...
            d.on(this.$svg, 'mousedown', '.handle.progress', (o, r) => {
                ...
                d.on(this.$svg, 'mousemove', (e) => {
                    ...
                    d.attr(n, 'width', n.owidth + a),
                        d.attr(o, 'points', i.get_progress_polygon_points()),
                        (n.finaldx = a);
                }),
                d.on(this.$svg, 'mouseup', () => {
                    (s = !1),
                        n &&
                            n.finaldx &&
                            (i.progress_changed(), i.set_action_completed());
                });
        }
        ...
        view_is(t) {
            return 'string' == typeof t
                ? this.options.view_mode === t
                : !!Array.isArray(t) &&
                      t.some((t) => this.options.view_mode === t);
        }
        get_task(t) {
