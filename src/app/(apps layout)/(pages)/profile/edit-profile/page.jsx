                        ...
                        <Col lg={10} sm={9} xs={8}>
                            <Tab.Content>
                                ...
                                <Tab.Pane eventKey="tabBlock2">
                                    ...
                                    <p className="mb-4">The Avatar component is used to represent a user, and displays
                                        the profile picture, initials or fallback icon.</p>
                                    <Form>
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Group className="mb-3">
                                        ...
                                        <Row className="gx-3">
                                            <Col sm={12}>
                                                <Form.Check className="form-check-lg">
                                                    ...
                                                    <Form.Check.Label htmlFor="customChecks1">let others find me by
                                                        email address</Form.Check.Label>
                                                    <Form.Text muted className="d-block">People who have your email
                                                        address will be able to connect you by Jampack</Form.Text>
                                                </Form.Check>
                                                <div className="separator"/>
                                                <Form.Check className="form-check-lg">
                                                    <Form.Check.Input id="customChecks2"/>
                                                    <Form.Check.Label htmlFor="customChecks2">Keep my phone number
                                                        private</Form.Check.Label>
                                                    <Form.Text muted className="d-block">No one can find you by your
                                                        phone number. Your phone number will not be shared with your
                                                        contact anymore.</Form.Text>
                                                </Form.Check>
                                                <div className="separator"/>
                                                <Form.Check className="form-check-lg">
                                                    <Form.Check.Input id="customChecks3"/>
                                                    <Form.Check.Label htmlFor="customChecks3">All Keep my location
                                                        sharing on</Form.Check.Label>
                                                    <Form.Text muted className="d-block">Jmapack webapp shares your
                                                        location wherever you go</Form.Text>
                                                </Form.Check>
                                                <div className="separator"/>
                                                <Form.Check className="form-check-lg">
                                                    <Form.Check.Input id="customChecks4"/>
                                                    <Form.Check.Label htmlFor="customChecks4">Share data through select
                                                        partnerships</Form.Check.Label>
                                                    <Form.Text muted className="d-block">Lorem ipsum dolor sit amet,
                                                        consectetur adipiscing elit. Pellentesque condimentum mauris
                                                        volutpat enim ornare iaculis. Curabitur euismod rutrum lorem id
                                                        lobortis. Cras ut ex dui. Nulla sed blandit tortor. In quam
                                                        diam, efficitur sit amet pulvinar eget, consequat placerat
                                                        arcu.</Form.Text>
                                                </Form.Check>
                                            </Col>
                                        </Row>
                                            ...
                                            <Col sm={12}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Text muted className="d-block">
                                                        ...
                                                        your password and your username, they&apos;d have to get a hold
                                                        of your phone. A <a href="#some"
                                                                            className="text-primary">6-digit</a> code
                                                        may be sent to a number you’ve previously provided. Codes can be
                                                        sent in a text message (SMS) or through a voice call, which
                                                        depends on the setting you chose. To verify it’s you, enter the
                                                        code on the sign-in screen.
                                                    </Form.Text>
                                                    <Button variant="primary" className="mt-3">Add
